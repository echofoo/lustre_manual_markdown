...
For more information about using `lctl`, see [*the section called “Setting Parameters with `lctl`”*](03.2-Lustre%20Operations.md#setting-parameters-with-lctl).
...
## Allocating Free Space on OSTs
  ...
  For more information about monitoring and managing free space, see [*the section called “Managing Free Space”*](03.8-Managing%20File%20Layout%20(Striping)%20and%20Free%20Space.md#managing-free-space).
...
See also [*the section called “ llobdstat”*](06.07-System%20Configuration%20Utilities.md#llobdstat)(`llobdstat`) and [*the section called “ `CollectL` ”*](03.1-Monitoring%20a%20Lustre%20File%20System.md#collectl) (`collectl`).
